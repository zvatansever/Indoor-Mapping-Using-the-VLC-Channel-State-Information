...
if print_figures
    ...
    figure
    plot(veh_true(1,49:89), veh_true(2,49:89), 'b-',...
        xWall, yWall,'-k',...
        x_led(2),y_led(2),'yo',...
...
i=49+24 % FIRST PEAK@17 SECOND PEAK@28
...
plot( x_led(2),y_led(2),'yo','MarkerEdgeColor','k','markerfacecolor','y','markersize',12,'linewidth',2)
%% north-south
...
led2.veh=[veh_true(1,i),veh_true(2,i)];
led2.a=[veh_true(1,i),(veh_true(2,i)+beta1)];
led2.b=[veh_true(1,i),(veh_true(2,i)-(beta2+alpha))];
led2.c=[veh_true(1,i),(veh_true(2,i)-beta1)];
led2.d=[veh_true(1,i),(veh_true(2,i)+(beta2+alpha))];
led2.beta1=beta1;
led2.beta2=beta2+alpha;
