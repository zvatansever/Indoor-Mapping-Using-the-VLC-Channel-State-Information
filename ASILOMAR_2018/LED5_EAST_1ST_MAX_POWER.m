...
led5east.veh=[veh_true(1,i),veh_true(2,i)];
led5east.a=[veh_true(1,i)+beta1,veh_true(2,i)];
led5east.b=[veh_true(1,i)-beta1,veh_true(2,i)];
led5east.beta1=beta1;

save wallloc5east led5east
