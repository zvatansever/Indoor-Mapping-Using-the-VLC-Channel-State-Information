...
if print_figures
    ...
    figure
    plot(veh_true(1,222:260), veh_true(2,222:260), 'b-',...
        xWall, yWall,'-k',...
        x_led(6),y_led(6),'^k','markerfacecolor','y','markersize',12,'linewidth',2)
...
hold on
plot( x_led(6),y_led(6),'ko','markerfacecolor','y','markersize',12,'linewidth',2)
...
led6.los=LOSP;
led6.a=[(veh_est(1,j(i))+beta1(i)),veh_est(2,j(i))];
led6.b=[(veh_est(1,j(i))-beta2(i)-alpha(i)),veh_est(2,j(i))];
