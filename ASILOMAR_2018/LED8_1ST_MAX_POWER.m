...
if print_figures
    ...
    figure
    plot(veh_true(1,310:350), veh_true(2,310:350), 'b-',...
        xWall, yWall,'-k',...
        x_led(8),y_led(8),'yo','MarkerEdgeColor','k','markerfacecolor','y','markersize',12,'linewidth',2)
...
i=310+19; % FIRST PEAK@17 SECOND PEAK@28
...
plot( x_led(8),y_led(8),'yo','MarkerEdgeColor','k','markerfacecolor','y','markersize',12,'linewidth',2)
%% north-south
...
led8.veh=[veh_true(1,i),veh_true(2,i)];
led8.a=[veh_true(1,i)-beta1,veh_true(2,i)];
led8.b=[veh_true(1,i)+beta2+alpha,veh_true(2,i)];
led8.c=[veh_true(1,i)+beta1,veh_true(2,i)];
led8.d=[veh_true(1,i)-beta2-alpha,veh_true(2,i)];
led8.beta1=beta1;
led8.beta2=beta2+alpha;
save wallloc8 led8
