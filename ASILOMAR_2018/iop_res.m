...
wallPerimeter(:,:) =[ wallFeatures(1,1,1) wallFeatures(1,1,2) wallFeatures(2,1,1) wallFeatures(2,1,2);
    wallFeatures(1,1,2) wallFeatures(1,1,3) wallFeatures(2,1,2) wallFeatures(2,1,3);
    wallFeatures(1,1,3) wallFeatures(1,1,4) wallFeatures(2,1,3) wallFeatures(2,1,4);
    wallFeatures(1,1,4) wallFeatures(1,1,1) wallFeatures(2,1,4) wallFeatures(2,1,1)];
...
figure
    ...
    plot(veh_true(1,1:220),veh_true(2,1:220),'b-','markerfacecolor','b','markersize',8,'linewidth',2)
    plot(veh_est(1,1:220),veh_est(2,1:220),'r-','markerfacecolor','r','markersize',8,'linewidth',2)

    plot( x_led,y_led,'yo','markerfacecolor','y','markersize',12,'linewidth',2)
    plot(xWall, yWall,'-k','linewidth',2)

    plot([led1.a(1) led2.a(1) led3.a(1) led4.a(1) 9.12],...
         [led1.a(2) led2.a(2) led3.a(2) led4.a(2) 2.01],...
         'gs-','markerfacecolor','g','markersize',12,'linewidth',4)

      plot([led1.c(1) led2.c(1) led3.c(1) led4.c(1) 9.12],...
         [led1.c(2) led2.c(2) led3.c(2) led4.c(2) -.5],...
         's-','color',[.8 .8 .8],'markerfacecolor',[.8 .8 .8],'markersize',8,'linewidth',4)
