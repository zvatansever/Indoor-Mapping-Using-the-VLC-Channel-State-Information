...
if print_figures
    ...
    figure
    plot(veh_true(1,261:310), veh_true(2,261:310), 'b-',...
        xWall, yWall,'-k',...
        x_led(7),y_led(7),'^k','markerfacecolor','y','markersize',12,'linewidth',2)
end
grid on;
...
hold on
plot( x_led(7),y_led(7),'ko','markerfacecolor','y','markersize',12,'linewidth',2)
...
led7.los=LOSP;
led7.a=[(veh_est(1,j(i))+beta1(i)),veh_est(2,j(i))];
led7.b=[(veh_est(1,j(i))-beta2(i)-alpha(i)),veh_est(2,j(i))];
