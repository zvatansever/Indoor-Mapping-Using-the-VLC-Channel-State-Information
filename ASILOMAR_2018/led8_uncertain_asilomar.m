...
if print_figures
    ...
    figure
    plot(veh_true(1,311:350), veh_true(2,311:350), 'b-',...
        xWall, yWall,'-k',...
        x_led(8),y_led(8),'^k','markerfacecolor','y','markersize',12,'linewidth',2)
end
grid on;
...
hold on
plot( x_led(8),y_led(8),'ko','markerfacecolor','y','markersize',12,'linewidth',2)
plot(xWall, yWall,'-k','linewidth',2)
plot((veh_est(1,j(i))-beta1(i)),veh_est(2,j(i)),'rp','markerfacecolor','r','markersize',12)
plot((veh_est(1,j(i))+beta2(i)+alpha(i)),veh_est(2,j(i)),'rp','markerfacecolor','r','markersize',12)
...
led8.los=LOSP;
led8.a=[(veh_est(1,j(i))-beta1(i)),veh_est(2,j(i))];
led8.b=[(veh_est(1,j(i))+beta2(i)+alpha(i)),veh_est(2,j(i))];
