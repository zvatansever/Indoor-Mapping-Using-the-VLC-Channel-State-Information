...
i=90+24 % FIRST PEAK@17 SECOND PEAK@28
...
plot( x_led(3),y_led(3),'yo','MarkerEdgeColor','k','markerfacecolor','y','markersize',12,'linewidth',2)
%% north-south
...
led3.veh=[veh_true(1,i),veh_true(2,i)];
led3.a=[veh_true(1,i),(veh_true(2,i)+beta1)];
led3.b=[veh_true(1,i),(veh_true(2,i)-(beta2+alpha))];
led3.c=[veh_true(1,i),(veh_true(2,i)-beta1)];
led3.d=[veh_true(1,i),(veh_true(2,i)+(beta2+alpha))];
led3.beta1=beta1;
led3.beta2=beta2+alpha;
save wallloc3 led3
