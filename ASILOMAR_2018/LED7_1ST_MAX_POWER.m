...
i=261+31; % FIRST PEAK@17 SECOND PEAK@28
...
plot( x_led(7),y_led(7),'yo','MarkerEdgeColor','k','markerfacecolor','y','markersize',12,'linewidth',2)
%% north-south
...
led7.veh=[veh_true(1,i),veh_true(2,i)];
led7.a=[veh_true(1,i)+beta1,veh_true(2,i)];
led7.b=[veh_true(1,i)-beta2-alpha,veh_true(2,i)];
led7.c=[veh_true(1,i)-beta1,veh_true(2,i)];
led7.d=[veh_true(1,i)+beta2+alpha,veh_true(2,i)];
led7.beta1=beta1;
led7.beta2=beta2+alpha;
save wallloc7 led7
