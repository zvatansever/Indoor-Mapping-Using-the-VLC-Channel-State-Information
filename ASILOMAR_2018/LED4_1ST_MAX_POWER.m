...
if print_figures
    ...
    figure
    plot(veh_true(1,130:172), veh_true(2,130:172), 'b-',...
        xWall, yWall,'-k',...
        x_led(4),y_led(4),'yo',...
...
i=130+24; % FIRST PEAK@17 SECOND PEAK@28
...
plot( x_led(4),y_led(4),'yo','MarkerEdgeColor','k','markerfacecolor','y','markersize',12,'linewidth',2)
%% north-south
...
led4.veh=[veh_true(1,i),veh_true(2,i)];
led4.a=[veh_true(1,i),(veh_true(2,i)+beta1)];
led4.b=[veh_true(1,i),(veh_true(2,i)-(beta2+alpha))];
led4.c=[veh_true(1,i),(veh_true(2,i)-beta1)];
led4.d=[veh_true(1,i),(veh_true(2,i)+(beta2+alpha))];
led4.beta1=beta1;
led4.beta2=beta2+alpha;
save wallloc4 led4
