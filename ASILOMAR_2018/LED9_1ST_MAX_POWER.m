...
if print_figures
    ...
    plot(veh_true(1,351:end), veh_true(2,351:end), 'b-',...
        xWall, yWall,'-k',...
        x_led(9),y_led(9),'yo','MarkerEdgeColor','k','markerfacecolor','y','markersize',12,'linewidth',2)
...
i=351+22; % FIRST PEAK@17 SECOND PEAK@28
...
plot( x_led(9),y_led(9),'yo','MarkerEdgeColor','k','markerfacecolor','y','markersize',12,'linewidth',2)
%% north-south
...
led9.veh=[veh_true(1,i),veh_true(2,i)];
led9.a=[veh_true(1,i)-beta1,veh_true(2,i)];
led9.b=[veh_true(1,i)+beta2+alpha,veh_true(2,i)];
led9.c=[veh_true(1,i)+beta1,veh_true(2,i)];
led9.d=[veh_true(1,i)-beta2-alpha,veh_true(2,i)];
led9.beta1=beta1;
led9.beta2=beta2+alpha;
save wallloc9 led9
