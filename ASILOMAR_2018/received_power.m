...
%  plot(veh_est(1,locs_1(2))*scale,(veh_est(2,locs_1(2))+beta1*10)*scale,'rp','markerfacecolor','y','markersize',12)
 plot((veh_est(1,locs_1(2))+(beta1*10))*scale, veh_est(2,locs_1(2))*scale,'rp','markerfacecolor','y','markersize',12)

% plot(veh_est(1,locs_1(1))*scale,(veh_est(2,locs_1(1))-((alpha+beta1)*10))*scale,'rp','markerfacecolor','y','markersize',12)
...
% axis equal;
 ...
 LED5_user_east.wall_north=[veh_est(1,locs_1(1))*scale (veh_est(2,locs_1(1))+(beta1*10))*scale];
 LED5_user_east.wall_south=[veh_est(1,locs_1(1))*scale,(veh_est(2,locs_1(1))-beta1*10)*scale];
LED5_user_east.imp_res=imP1;
LED5_user_east.time=x_t1;
LED5_user_east.user_pos_true=[veh_true(1,locs_1(1))*scale veh_true(2,locs_1(1))*scale];
LED5_user_east.user_pos_est=[veh_est(1,locs_1(1))*scale veh_est(2,locs_1(1))*scale];
LED5_user_east.wall_south=[veh_est(1,locs_1(1))*scale (veh_est(2,locs_1(1))-((alpha+beta2)*10))*scale];

% save LED5_User_East LED5_user_east