...
for i=1:48
    ...
    plot(veh_true(1,i)*scale,veh_true(2,i)*scale,'rs','markerfacecolor','y','markersize',12)
    %% north-south
    plot(veh_est(1,i)*scale,(veh_est(2,i)+beta2(i)*10)*scale,' b.','markerfacecolor','y','markersize',12)
    
    plot(veh_est(1,i)*scale,(veh_est(2,i)-((beta1(i))*10))*scale,'r.','markerfacecolor','y','markersize',12)
