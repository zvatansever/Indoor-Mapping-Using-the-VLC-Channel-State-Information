...
if print_figures
    ...
    figure
    plot(veh_true(1,173:221), veh_true(2,173:221), 'b-',...
        xWall, yWall,'-k',...
        x_led(5),y_led(5),'yo',...
...
i=173+34; % FIRST PEAK@17 SECOND PEAK@28
...
plot( x_led(5),y_led(5),'yo','MarkerEdgeColor','k','markerfacecolor','y','markersize',12,'linewidth',2)
%% north-south
...
led5.veh=[veh_true(1,i),veh_true(2,i)];
led5.a=[veh_true(1,i),(veh_true(2,i)+beta1)];
led5.b=[veh_true(1,i),(veh_true(2,i)-(beta2+alpha))];
led5.c=[veh_true(1,i),(veh_true(2,i)-beta1)];
led5.d=[veh_true(1,i),(veh_true(2,i)+(beta2+alpha))];
led5.beta1=beta1;
led5.beta2=beta2+alpha;
save wallloc5_60 led5
